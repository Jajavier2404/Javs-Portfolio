      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="flex flex-col-reverse items-center gap-12 md:flex-row md:gap-16">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="hero-enter hero-enter-delay-2 mb-4 text-4xl font-bold leading-tight text-foreground md:text-6xl lg:text-7xl">
              {name}
              <span className="neon-text">.</span>
            </h1>
            <div className="hero-enter hero-enter-delay-3 mb-4 text-xl text-muted-foreground md:text-2xl h-8">
              <Typewriter
                texts={[role, "UI/UX Enthusiast", "Open Source Contributor", "Problem Solver"]}
              />
            </div>
            <p className="hero-enter hero-enter-delay-3 mb-8 max-w-lg text-base leading-relaxed text-muted-foreground md:text-lg">
              {bio}
            </p>
